...
import com.rayson.eldoretonlinemarket.models.Product;
import com.rayson.eldoretonlinemarket.util.BigDecimalUtil;
...
public class ViewProductFragment extends Fragment {
    ...
    private void setProduct(){
        ...
        mPrice.setText(format.format(BigDecimalUtil.getValue(mProduct.getPrice())));
    }
